...
const JoinGrow = () => {
    return (
        <>
            <section id='events' className='join-grow-section-bg bg-cover bg-center bg-no-repeat py-6 md:py-[40px] lg:py-12 xl:pt-[42.36px] xl:pb-[42.6px]'>
                <div className='max-w-[min(863px,100%-24px)] mx-auto'>
                    ...
                    <p className=' ff-roboto text-center text-[#B7B9BC] max-w-[534px] mx-auto leading-[1.5] mb-4 xl:mb-[45px]'>Lpsum diam curabitur tincidunt sed vitae nulla a porttitor sed. Eros sem sed gravida in nulla dictum </p>
