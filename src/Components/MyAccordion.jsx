        ...
        <>
            <section className="bg-[#EFEFEF] xl:pt-[87px] py-6 md:py-[40px] lg:py-12 xl:pb-[150px]">
                <div className="max-w-[min(957px,100%-24px)] mx-auto">
                    <h2 className="text-[30px] md:text-[40px] lg:text-[48px] xl:text-[52px] ff-outfit leading-[1.0962] mb-6 lg:mb-[40px] font-semibold text-[#0D0D0D]  text-center">Frequently Asked Questions</h2>
                            ...
                            <div className="accordion-item" key={index}>
                                    <div className="accordion-title w-full px-4 ff-outfit text-[20px] text-[#0D0D0D] leading-[1.1] font-medium" onClick={() => toggleAccordion(index)}>
                                        <div className="flex items-center justify-between">
                                            {item.title}
                                            <div>{openAccordion === index ? <img src={AccordionOpenIcon} alt="icon" className="w-[15px]" /> : <img src={AccordionCloseIcon} alt="icon" className="w-[15px]" />}</div>
                                        </div>
                                    </div>
